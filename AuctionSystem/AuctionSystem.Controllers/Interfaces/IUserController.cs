namespace AuctionSystem.Controllers.Interfaces
{
    ...
    {
        void CreateUser(string username, string name, string address, string email, string phone, string dateOfBirth, Gender gender, bool isAdmin, Zip zip, int coins, List<Payment> payments);
